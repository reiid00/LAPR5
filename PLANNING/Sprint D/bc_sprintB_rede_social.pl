...
no(51,rodolfo,[natureza,musica,carros,futebol,lisboa]).
%no(61,rita,[moda,tecnologia,cinema]).

%LIGACOES TESTE DO GENERO DA BD PARA TESTES
ligacao("6543","9876",7,3).
ligacao("6543","5465",4,9).
ligacao("9876","5465",1,1).
ligacao("9876","1234",4,5).
...
grupo(1,informatica,[tecnologia,csharp,js]).
grupo(2,teatro,[arte,teatro]).
grupo(3,"bladee fan club",[musica,arte]).
grupo(4,"adeptos fcp",[desporto,futebol,porto]).
grupo(5,"adeptos slb",[desporto,futebol,lisboa]).
grupo(6,"clube do antonio",[natureza,musica,carros,futebol,lisboa]).   %clube com todas as tags do antonio para testar sugestoes

group_users(1,[41,42,43]).
group_users(2,[31,32,51,12]).
group_users(3,[21,22,23]).
group_users(4,[]).
group_users(5,[21,22]).
group_users(6,[1,21,22]).

emocoes(1,1.0,0.0). %userid,alegria,angustia
