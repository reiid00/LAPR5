...
@Component({
  selector: 'app-tag-all-relacoes',
  templateUrl: './tag-all-relacoes.component.html',
  styleUrls: ['./tag-all-relacoes.component.css']
})
export class TagAllRelacoesComponent implements OnInit{
  ...
  async getTagsRelacoesProprio(){
    const relacoesFromService$ = this.relationService.getRelations().pipe(map(response=>response));
